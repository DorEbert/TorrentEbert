...
/*#UsersTable td, #UsersTable th #FilesTable td, #FilesTable th {*/
...
<body>
     ...
     <asp:TextBox ID="Application_User_ID" type="hidden" name="Application_User_ID" runat="server" ></asp:TextBox>
         <asp:Panel ID="Panel1" runat="server" Height="465px" Width="689px">
             <label for="UserName"><b>UserName</b></label>
             <asp:TextBox ID="txt_UserName" name="txt_UserName" runat="server" Visible="True"></asp:TextBox>

             <label for="psw"><b>Password</b></label>
             <asp:TextBox ID="txt_Password" name="txt_Password" runat="server" Visible="True"></asp:TextBox>

             <label for="FirstName"><b>First Name</b></label>
             <asp:TextBox ID="txt_FirstName" name="txt_FirstName" runat="server" Visible="True"></asp:TextBox>

             <label for="LastName"><b>Last Name</b></label>
             <asp:TextBox ID="txt_LastName" name="txt_LastName" runat="server" Visible="True"></asp:TextBox>
            
             <label for="date"><b>Date Of Birth</b></label>
             <input id="dt_DateOfBirth" runat="server" placeholder="Date Of Birth" name="dt_DateOfBirth" ><br />
